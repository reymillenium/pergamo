unit UfrmQRReporteArchivosPorCarneIdentidad;
...
type
  TQuickReportArchivosPorCarneIdentidad = class(TQuickRep)
...
var
  QuickReportArchivosPorCarneIdentidad: TQuickReportArchivosPorCarneIdentidad;
...
procedure TQuickReportArchivosPorCarneIdentidad.QuickRepPreview(Sender: TObject);
begin
  //Le mando al printer del Preview la información de este mismo reporte
  frmPreviewReporteArchivosPorCarneIdentidad.Preview.QRPrinter := QuickReportArchivosPorCarneIdentidad.QRPrinter;

  //Mando a que se muestre el Preview
  frmPreviewReporteArchivosPorCarneIdentidad.Position:= poDesktopCenter;
  frmPreviewReporteArchivosPorCarneIdentidad.ShowModal;
end;
