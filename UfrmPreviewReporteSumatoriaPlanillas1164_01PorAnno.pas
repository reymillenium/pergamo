...
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteSumatoriaPlanillas1164_01PorAnno.Caption:= 'BookLogger. Vista Previa. Exportando el Reporte del Resumen Anual de Planillas 1164-01 a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteSumatoriaPlanillas1164_01PorAnno.Caption:= 'BookLogger. Vista Previa del Reporte del Resumen Anual de Planillas 1164-01. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
      ...
      begin
        ...
        if (Preview.QRPrinter.PageCount = 0)
          then
            begin
              //Especifico la posicion de pagina
              frmPreviewReporteSumatoriaPlanillas1164_01PorAnno.Caption:= 'BookLogger. Vista Previa del Reporte del Resumen Anual de Planillas 1164-01. Página ' + IntToStr(Preview.PageNumber) + ' de 1';
            end
              else
                begin
                  //Especifico la posicion de pagina
