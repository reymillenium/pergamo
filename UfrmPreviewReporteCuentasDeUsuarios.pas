...
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteCuentasDeUsuarios.Caption:= 'BookLogger. Vista Previa. Exportando el Reporte de Cuentas de Usuarios a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteCuentasDeUsuarios.Caption:= 'BookLogger. Vista Previa del Reporte de Cuentas de Usuarios. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
