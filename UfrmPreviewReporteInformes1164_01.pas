unit UfrmPreviewReporteInformes1164_01;
...
type
  TfrmPreviewReporteInformes1164_01 = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteInformes1164_01: TfrmPreviewReporteInformes1164_01;
...
procedure TfrmPreviewReporteInformes1164_01.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteInformes1164_01.Caption:= 'BookLogger. Vista Previa. Exportando el Reporte de Planillas 1164-01 a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteInformes1164_01.Caption:= 'BookLogger. Vista Previa del Reporte de Planillas 1164-01. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteInformes1164_01.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteInformes1164_01.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteInformes1164_01.PreviewPageAvailable(Sender: TObject; PageNum: Integer);
begin
