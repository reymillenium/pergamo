...
begin
  ...
  DataModuleInformes.spSelecID_MunicipioParaPlanilla1164_01PorNombreMunicipio.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //*** Le pasamos los parámetros de la Planilla 1164-01, al StoredProc. ***
  //Posicionamiento
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanilla1164_01PorCodigoYAnno.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanilla1164_01PorID_Planilla.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la inserción de datos, en la BD
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecMunicipiosParaPlanilla1164_01PorNombreProvincia.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanillas1164_01PorAnno.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanillas1164_01PorProvincia.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanillas1164_01PorProvinciaYAnno.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecPlanillas1164_01Todas.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
...
begin
  ...
  //Aquí se hace la busqueda de datos, en la BD
  DataModuleInformes.spSelecSumatoriaPlanillas1164_01PorAnno.Open; //<- SÍ genera datos de respuesta el StoredProc, por eso se muestra esto.
